...
- 🖥️ 集中查看分布在不同设备上的 Agent 状态，避免任务散落在不同机器和对话里。
...
### 🖥️ Built For PM, Devices, And Agents
...
- 🖥️ See agent status across multiple devices instead of losing tasks in local machines or chat threads.
